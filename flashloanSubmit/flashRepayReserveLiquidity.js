...
exports.DISCRIMINATOR = Buffer.from([185, 117, 0, 203, 96, 245, 180, 186]);
exports.layout = borsh.struct([
    borsh.u64("liquidityAmount"),
    borsh.u8("borrowInstructionIndex"),
]);
function flashRepayReserveLiquidity(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
