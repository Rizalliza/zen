...
exports.DISCRIMINATOR = Buffer.from([209, 157, 53, 210, 97, 180, 31, 45]);
exports.layout = borsh.struct([
    borsh.u64("mode"),
    borsh.array(borsh.u8(), 72, "value"),
]);
function updateLendingMarket(args, accounts, remainingAccounts = [], programAddress = programId_1.PROGRAM_ID) {
    const keys = [
        {
